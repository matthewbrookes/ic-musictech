...
const shows = [
  {
    ...
    description:
      "Bringing a slice of vibrant electronic music to your ears, the format stays true to the original ethos here at Music Tech. " +
  ...
  },
  {
    ...
    description:
      "Hear the latest, up and coming tunes from the world of music beyond the charts and delve into the underground world of electronica.",
...
const Radio = () => (
  <div>
    <Intro>
      Musictech host their own radio sessions and several of our Musictech DJs
      host their own radio shows on{" "}
      <a href="http://www.icradio.com/">IC Radio</a>. Listen to some of
      Musictech&apos;s past sessions{" "}
      <a href="http://www.icradio.com/shows/957/">here</a> and check out when to
      hear our DJs playing live below.
    </Intro>
